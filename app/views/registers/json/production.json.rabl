...
node(I18n.t("activerecord.attributes.production.productive_physical_coverage_amount")) { |p| p.productive_physical_coverage_amount }
node(I18n.t("activerecord.attributes.production.productive_physical_coverage_unit"))   { |p| p.productive_physical_coverage_unit }
